...
<div class="row row-overflow">
  ...
  <div class="cursor" id="bt_healthoctoprint" style="background-color : #ffffff; height : 120px;margin-bottom : 10px;padding : 5px;border-radius: 2px;width : 160px;margin-left : 10px;" >
    <center>
...
<div class="eqLogicThumbnailContainer">
         <?php
                foreach ($eqLogics as $eqLogic) {
                    ...
                    echo "<center>";
                    echo '<img src="plugins/octoprint/plugin_info/octoprint_icon.png" height="105" width="95" />';
                    echo "</center>";
